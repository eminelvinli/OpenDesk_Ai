...
> - **Styling:** Tailwind CSS v4 + Ant Design 6.x
> - **Port:** 7001
> - **UI Library:** Ant Design (NOT shadcn/Radix)
...
- **🔴 Tests are MANDATORY**: Every component gets unit tests (React Testing Library)
- **🔴 Documentation is REQUIRED**: Component props documented, README for features
...
### ⛔ AppDataCo UI Library Standard

**This project uses Ant Design 6.x as the primary component library.**
...
❌ **DO NOT USE** (not installed in this project):
- shadcn/ui
- Radix UI
- Chakra UI
- Material UI
...
> 🟢 **AppDataCo uses Ant Design 6.x - no need to ask about UI library.**
...
3. **🔴 Write tests**: Component tests (React Testing Library) - NO EXCEPTIONS
4. **🔴 Add documentation**: JSDoc for components, README for features
5. **Run tests**: `npm test` must pass
6. **Verify functionality**: Test the change works as intended
7. **Report complete**: Only after ALL quality checks pass
